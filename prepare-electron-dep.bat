...
REM ieproxy.js.js
call javascript-obfuscator src/for-electron/crates/ieproxy.js --output public/for-electron/crates/ieproxy.js --compact true --control-flow-flattening true --dead-code-injection true
